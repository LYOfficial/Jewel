...
| 分野 | 機能 |
|---|---|
| プロジェクトデプロイ | Git リポジトリのクローン、ブランチと Compose ファイルの選択、環境変数編集、デプロイ、停止、再起動、再構築 |
...
Jewel は [MIT License](./LICENSE) の下で公開されています。

## 謝辞

Jewel の製品方針は [Dokploy](https://github.com/Dokploy/dokploy) と [Portainer](https://github.com/portainer/portainer) から着想を得ています。バックアップ連携では `rclone`、`bypy`、[AnyShare-Unofficial](https://github.com/isHarryh/AnyShare-Unofficial) を使用、または互換利用しています。
