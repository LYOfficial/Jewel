...
// ===== Images =====
//
// Image routes now live in routes-images.js and are mounted in index.js
// at /api/containers/images (BEFORE this router) so they aren't shadowed
// by the /:id wildcard below.
